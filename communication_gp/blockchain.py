...
def mine():
    ...
    if not blockchain.valid_proof(
        blockchain.last_block["previous_hash"], values["proof"]
    ):
        print("ERROR!")
...
def last_block_string():
    response = {"last_block_string": blockchain.last_block}
    return jsonify(response), 200
